...
Route::group([
  ...
  'middleware' => [
    ...
    Route::post('/user/session/triggered-form', 'UserController@setTriggeredForms')->name('session.triggered-form');
    ...
    Route::post('/document/download-ws-fusion/', 'ContentController@downloadWSFusion')->name('document.download-ws-fusion');
