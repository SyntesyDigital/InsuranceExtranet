    ...
    */
    finalRedirect() {
      ...
      if(this.props.finalRedirectUrl != ""){
        window.location.href = this.props.finalRedirectUrl+"?"+this.getUrlParameters();
      }
      else {
    ...
    render() {
        return (
          <div className={"form-component element-form-wrapper row "+(this.state.loading == true ? 'loading' : '')}>
            {
