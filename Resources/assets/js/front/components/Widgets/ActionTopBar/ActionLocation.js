...
export default class ActionLocation extends Component {
    ...
    render() {
        ...
        const title = SITE_CONFIG_GENERAL.TITLE_LOCALITATION_BTN !== undefined
            && SITE_CONFIG_GENERAL.TITLE_LOCALITATION_BTN.value !== null ?
            SITE_CONFIG_GENERAL.TITLE_LOCALITATION_BTN.value
            : '';

        const wsTotal = SITE_CONFIG_GENERAL.WS_TOTAL_LOCALITATION_BTN !== undefined
            && SITE_CONFIG_GENERAL.WS_TOTAL_LOCALITATION_BTN.value !== null ?
            SITE_CONFIG_GENERAL.WS_TOTAL_LOCALITATION_BTN.value
            : '';
