...
class ElementsDataTable extends Component {
    ...
    setDatatable()
    {
        ...
        //console.log("ElementsDataTable :: setDatatable route : ",route,$(this.refs.main));
        ...
        var table = $(this.refs.main).DataTable({
            ...
            order: [],
            pageLength: 10,
            ajax: '/architect/elements/datatable',
            columns: [
    ...
    destroyDatatable() {
      ...
      console.log("ElementsDataTable :: destroy datatable ");
    ...
    {
        var _this = this;
        $(document).on('click','#table-elements .add-item',function(e){
          e.preventDefault();
    ...
    render() {
        return (
          <div>
            <table ref="main" className="table" id="table-elements" style={{width:"100%"}}>
                <thead>
                   <tr>
...
export default ElementsDataTable;
